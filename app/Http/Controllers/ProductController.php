...
class ProductController extends Controller
{
    ...
    public function viewProduct(int $id)
    {
        ...
        return view('admin.product.view-jq', [
            'product' => $product
        ]);
    }
    ...
    public function updateProduct(Request $request)
    {
        ...
        if (isset($postdata['id']) && $postdata['id'] != '') {
            ...
            // before we saving the data lets sanitising them a bit.
            if (isset($postdata['description'])) {
                $postdata['description'] = strip_tags($postdata['description']);
            }
            if (isset($postdata['label'])) {
                $postdata['label'] = strip_tags($postdata['label']);
            }
            ...
            return redirect('/product/view/' . $postdata['id']);
        } else {
    ...
    public function addProductItems(Request $request)
    {
        ...
        if (isset($postdata['id']) || isset($postdata['sku'])) {
            ...
            \Session::flash('flashMessages', $flashMessages);
            return redirect('/product/view/' . $postdata['product_id']);
        } else {
